...
from muon_new import MuonWithAuxAdam
...
def do_train(train_config, accelerator):
    ...
    if accelerator.is_main_process:
        ...
        logger.info(f"Optimizer: Muon, lr={train_config['optimizer']['lr']}, beta2={train_config['optimizer']['beta2']}")
    ...
    optim_params = [
        dict(params=hidden_weights, use_muon=True,
            lr=train_config['optimizer']['lr'], weight_decay=0.01), #10*
        dict(params=hidden_gains_biases, use_muon=False,
            lr=train_config['optimizer']['lr'], betas=(0.9, train_config['optimizer']['beta2']), weight_decay=0, eps=1e-08),
            ]
    opt = MuonWithAuxAdam(optim_params)
