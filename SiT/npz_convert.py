...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-fid-samples", type=int, default=10_000, help="Number of samples to convert.")
    ...
    folder_name = f"{exp_name}-{ckpt_string_name}-{args.resolution}-vae-{args.vae}-" \
                  f"cfg-{args.cfg_scale}-cfgh-{args.guidance_high}-ig-{args.ig_scale}-iglow{args.ig_guidance_low}-igh{args.ig_guidance_high}-seed-{args.global_seed}-{args.mode}"
